...
final class Theme {
	...
	final class Images {
		...
		static let email = UIImage(named: "Email")!.withTintColor(Theme.Colors.tint)
		static let password = UIImage(named: "Password")!.withTintColor(Theme.Colors.tint)
		...
		static let google = UIImage(named: "Google")!.withTintColor(Theme.Colors.tint)
		static let facebook = UIImage(named: "Facebook")!.withTintColor(Theme.Colors.tint)
