//
//  RootControllerTransition.swift
//  Aika
//
//  Created by Anton Efimenko on 26.11.2017.
...
public extension UIWindow {
	...
	struct TransitionOptions {
		...
		///   - style: style
		///	  - duration: duration
		public init(direction: TransitionOptions.Direction = .toRight, style: TransitionOptions.Curve = .linear, duration: TimeInterval = 0.20) {
