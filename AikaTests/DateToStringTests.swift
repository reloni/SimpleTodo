...
class DateToStringTests: XCTestCase {
	...
	func testFullWithinCurrentYear() {
		...
		date = Date()
		localFormatter.dateFormat = "\(Date.DateFormat.dayOfWeek.rawValue) \(Date.DateFormat.time.rawValue)"
		XCTAssertEqual(localFormatter.string(from: date), date.toString(format: .full(withTime: true), dateFormatter: injectFormatter))
	...
	func testFullInPreviousYear() {
		...
		localFormatter.dateFormat = "\(Date.DateFormat.dateFull.rawValue) \(Date.DateFormat.time.rawValue)"
		XCTAssertEqual(localFormatter.string(from: date), date.toString(format: .full(withTime: true), dateFormatter: injectFormatter))
	...
	func testRelativeWithinCurrentYear() {
		...
		date = Date()
		localFormatter.dateFormat = "\(Date.DateFormat.time.rawValue)"
